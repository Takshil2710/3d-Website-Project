    ...
    emailjs
      .send(
        ...
        'template_jrv459j',
        {
          ...
          to_email: "support@octacoretechnologies.com",
    ...
    <div className="xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className={`bg-tertiary py-3 px-8 rounded-xl outline-none w-fit text-white font-bold shadow-md shadow-primary transition duration-300 ease-in-out transform hover:scale-105 ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
            disabled={loading}
